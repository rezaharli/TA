          ...
          <?php } elseif ($jenis == 'himpunan') { ?>
            <li>
              <a href="#"><i class="fa fa-user"></i>Akun Himpunan<i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                  <li><a href="<?php echo base_url('himpunan') ?>"><i class="fa fa-edit"></i>Edit Profil Himpunan</a></li>
                </ul>
            </li>
            <li>
              <a href="#"><i class="fa fa-book"></i> <span>Pengajuan Proposal</span><i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
