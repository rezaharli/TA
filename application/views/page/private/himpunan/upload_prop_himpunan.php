                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="tujuan_kegiatan" placeholder="Tujuan Kegiatan" name="tujuan_kegiatan"><?php echo set_value('judul') ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Sasaran Kegiatan *</label>
                                <textarea class="form-control" id="sasaran_kegiatan" placeholder="Sasaran Kegiatan" name="sasaran_kegiatan"><?php echo set_value('judul') ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Tanggal Kegiatan *</label>
                                <input type="text" class="form-control" id="datepicker" placeholder="Tanggal Kegiatan" name="tanggal_kegiatan" value="<?= set_value('tanggal_kegiatan') ?>">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="anggaran" placeholder="ex:1000000" name="anggaran" value="<?= set_value('anggaran') ?>">
                            </div>
                            <div class="form-group">
                                <label>Penutup *</label>
