                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" placeholder="Judul Proposal" name="judul" value="<?php echo $judul ?>">
                            </div>
                            <div class="form-group">
                                <label>Tema Kegiatan *</label>
                                <textarea class="form-control" id="tema_kegiatan" placeholder="Tema Kegiatan" name="tema_kegiatan"><?php echo $tema_kegiatan ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Tujuan Kegiatan *</label>
                                <textarea class="form-control" id="tujuan_kegiatan" placeholder="Tujuan Kegiatan" name="tujuan_kegiatan"><?php echo $tujuan_kegiatan ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Sasaran Kegiatan *</label>
                                <textarea class="form-control" id="sasaran_kegiatan" placeholder="Sasaran Kegiatan" name="sasaran_kegiatan"><?php echo $sasaran_kegiatan ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Tanggal Kegiatan *</label>
                                <input type="text" class="form-control" id="datepicker" placeholder="Tanggal Kegiatan" name="tanggal_kegiatan" value="<?php echo $tanggal_kegiatan ?>">
                            </div>
                            <div class="form-group">
                                <label>Tempat Kegiatan *</label>
                                <input type="text" class="form-control" id="tempat_kegiatan" placeholder="Tempat Kegiatan" name="tempat_kegiatan" value="<?php echo $tempat_kegiatan ?>">
                            </div>
                        </div><!-- /.box-body -->                   
                    </div><!-- /.box -->
                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="bentuk_kegiatan" placeholder="Bentuk Kegiatan" name="bentuk_kegiatan"><?php echo $bentuk_kegiatan ?></textarea> 
                            </div>
                            <div class="form-group">
                                <label>Anggaran Biaya (Total) *</label>
                                <input type="text" class="form-control" id="anggaran" placeholder="ex:1000000" name="anggaran" value="<?php echo $anggaran ?>">
                            </div>
                            <div class="form-group">
                                <label>Penutup *</label>
                                <textarea class="form-control" id="penutup" placeholder="Penutup" name="penutup"><?php echo $penutup ?></textarea>
                            </div>
